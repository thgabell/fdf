...
/*   Updated: 2023/03/29 21:10:31 by thgabell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	{
		s_fdf->x_translate = (s_fdf->img_width / 2) - ((s_fdf->s_map.width * s_fdf->zoom) / 2);
		s_fdf->y_translate = (s_fdf->img_height / 2) - ((s_fdf->s_map.height * s_fdf->zoom));
